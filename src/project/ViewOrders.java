...
public class ViewOrders extends JFrame {
	...
	public ViewOrders() throws SQLException {
		...
		lblNewLabel.setBounds(408, 11, 354, 61);
		...
		btnNewButton.setBounds(991, 469, 111, 43);
		...
		scrollPane.setBounds(10, 97, 1092, 361);
		...
		Object[] col= {"Book Name","User Name","Original Qty","Avaliable Qty","Order Qty","Price"};
		...
		while(rs.next()) {
			Object []row= {rs.getString(2),rs.getString(3),rs.getInt(4),rs.getInt(5),rs.getInt(6),rs.getDouble(7)};
			model.addRow(row);
		}
	}
